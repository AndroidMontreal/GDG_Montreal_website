...
import { getFooterNavData } from '@/data/headerNavData';
...
const Footer = () => {
  ...
  const footerNavData = getFooterNavData(language);
  const footerText = siteData.footer[language];
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-9">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-xs text-gray-400 italic">© {new Date().getFullYear()} GDG Montreal. {footerText.copyright}</p>
          </div>
